...
export const LOCALIZATION_EN: Record<string, string> = {
  ...
  // Kept for backwards compatibility with earlier integrators reading these keys.
  powerAcUsb: 'USB and power plug',
  powerOutletOnly: 'Power plug',
  usb: 'USB plug',
  usbOnly: 'USB plug',
  ...
  restricted_legroom: 'Constrained Legroom',
